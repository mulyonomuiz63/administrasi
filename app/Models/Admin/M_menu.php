...
class M_menu extends Model
{
    ...
    var $column_order = array('menu'); //set nama field yang bisa diurutkan
    ...
    {
        $builder = $this->db->table($this->tabel);
        $builder->where('idmenu', $id);
        return $builder->get();
    }

    public function updateWhere($data, $idmenu)
    {
    ...
    public function hapus($data, $idmenu)
    {
        $this->db->transBegin();
