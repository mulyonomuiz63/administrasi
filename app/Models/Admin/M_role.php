...
class M_role extends Model
{
    ...
    var $column_order = array('role'); //set nama field yang bisa diurutkan
    var $column_search = array('role'); //set nama field yang akan di cari
    ...
    {
        $builder = $this->db->table('role');
        $builder->where('idrole', $id);
        return $builder->get();
    }

    public function updateWhere($data, $idrole)
    {
    ...
    public function hapus($data, $idrole)
    {
        $this->db->transBegin();
